	...
	<div class="container">
  		<div class="panel-group" id="accordion">
    		<div class="panel panel-default">
	      		<div class="panel-heading text-center"># Nuevo Crucigrama # <button data-toggle="collapse" data-parent="#accordion" href="#collapse1" id="show" onclick='javascript:expand(showi)' type="button" class="btn btn-default btn-xs pull-right"><i id="showi" class="fa fa-chevron-down"></i></button></div>
	      		<div class="panel-body">
	      			<div class="row">
	      				<div class="col-md-8" align="center"><svg id="svgCW" width="100" height="100"></svg></div>
	          			<div class="col-md-2">
				            <form>
	      		...
	      		<div class="panel-footer" align="center"><button type="button" onclick="javascript:saveCrossword()" class="btn btn-default"><i class="fa fa-cloud-upload"></i> Guardar</button> <button type="button" onclick="javascript:newCrossword()" class="btn btn-default"><i class="fa fa-refresh"></i> Generar</button></div>
    		</div>
  		</div>
  </div>
</body>
