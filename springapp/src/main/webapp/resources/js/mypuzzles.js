...
PanelCrossword.prototype.create = function () {
	...
	var panelfooter = $('<div class="panel-footer"><button type="button" class="btn btn-default" onclick="removeCrossword(' + this.id +');"><i class="fa fa-recycle fa-lg"></i></button></div>');
...
PanelWordSearch.prototype.create = function () {
	...
	var panelfooter = $('<div class="panel-footer"><button type="button" class="btn btn-default" onclick="removeWordSearch(' + this.id +');"><i class="fa fa-recycle fa-lg"></i></button></div>');
